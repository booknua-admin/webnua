...
function RescheduleModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        <div className="flex shrink-0 items-start justify-between gap-4 border-b border-paper-2 px-4 pb-4 pt-5.5 md:px-7">
        ...
        <div className="flex shrink-0 flex-wrap items-center justify-between gap-3 border-t border-paper-2 bg-paper px-4 py-4 md:px-7">
