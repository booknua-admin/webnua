    ...
    <>
      ...
      <div className="px-10 py-10">
        ...
        <BuilderLayout
                ...
                <BuilderField label="Trust signals (4 stat cards)">
                  <BuilderFormRow>
                    <BuilderField label={voltlineTrust[0].label}>
                      <BuilderInput
                        defaultValue={voltlineTrust[0].value}
                        readOnly
                      />
                    </BuilderField>
                    <BuilderField label={voltlineTrust[1].label}>
                      <BuilderInput
                        defaultValue={voltlineTrust[1].value}
                        readOnly
                      />
                    </BuilderField>
                  </BuilderFormRow>
                  <BuilderFormRow>
                    <BuilderField label={voltlineTrust[2].label}>
                      <BuilderInput
                        defaultValue={voltlineTrust[2].value}
                        readOnly
                      />
                    </BuilderField>
                    <BuilderField label={voltlineTrust[3].label}>
                      <BuilderInput
                        defaultValue={voltlineTrust[3].value}
                        readOnly
                      />
                    </BuilderField>
                  </BuilderFormRow>
              ...
              <BuilderFormSection>
                <BuilderField
                  label={
                    <>
                      Common jobs menu{' '}
                      <AIPill>AI-suggested · edit prices</AIPill>
                    </>
                  }
                >
              ...
              <BuilderFooterActions
                ...
                actions={
                  <>
                    ...
                    <Button asChild>
                      <Link href={stepHref('automations')}>Continue →</Link>
                    </Button>
                  </>
                }
              />
          ...
          preview={<FunnelLandingPreview state={previewAfterTrust} />}
        />
      </div>
    </>
  );
