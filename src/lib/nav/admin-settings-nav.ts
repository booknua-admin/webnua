...
// defaults + Default seat limit (Cluster 8 · Session 3) and Plans (Cluster 9 ·
// Session 2) are the agency-policy surfaces that consume lib/agency/ (the
// policy resolver) and lib/billing/ (the plan catalog).
